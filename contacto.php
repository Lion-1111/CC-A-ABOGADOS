...
<body>
    ...
    <!-- Navbar -->
    <section class="margin-header" style="background-image: url(./assets/img/banners/Banner_2_3.jpg);background-size: 100%;background-position-y: 35%;">
        <div class=" mt-5 pt-5" style="padding-top:3rem;padding-bottom:3rem">
            <div class="col-12 pt-5 mb-5">
                <h3 class="title-4 text-center">Contáctanos</h3>
                <p class="text-white mb-2 mt-4 text-center"><img src="./assets/img/Iconos/alfiler.svg" class="mb-2" width="20"></img> <a href="https://goo.gl/maps/GWDfLhuSU3xPVbUy7" class="text-white">Plaza San
                        Buenaventura 1-29,
                        Ixtapaluca, Estado de México. CP 56530</a></p>
                <p class="text-white mb-2 text-center"><img src="./assets/img/Iconos/llamada-telefonica.svg" class="mb-2" width="20"></img> <a class="text-white" href="tel:+525550878159">55-50-87-81-59</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="./assets/img/Iconos/llamada-telefonica.svg" class="mb-2" width="20"></img> <a class="text-white" href="tel:+525534042896">55-34-04-28-96</a>
                </p>
                
                    <p class="text-white mb-2 text-center"> <img src="./assets/img/Iconos/correo.svg" class="" width="20"></img> contacto@abogados-cca.com</p>
                </a>
            </div>
        </div>
    </section>

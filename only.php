...
<body>
    ...
    <section class="margin-header" style="background-image: url(./assets/img/banners/Banner_2_4.jpg);background-size: 100%;">

        <div class="pt-5" style="padding:80px">

            <div class="col-12 pt-5 mb-5">

                <h1 class="title-4 text-center" style="color: #000 !important;">Solo para abogados</h1>
    ...
    <section class="col-12 aparece" id="cards">

        <div class="row mb-5">

            <div class="col-md-6 p-0 text-center"><img src="./assets/img/banners/Producto_1.jpg" class="img img-fluid" /></div>

            <div class="col-md-6 p-0 text-center"><img src="./assets/img/banners/Producto_2.jpg" class="img img-fluid" /></div>

            <div class="col-md-12 p-0 text-center"><img src="./assets/img/banners/Producto_3.jpg" class="img img-fluid" /></div>

            <div class="col-12 text-center mt-5 mb-5 pt-5">
            ...
            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/buho.jpg" class="img img-fluid" />

            </div>
            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/agenda1.jpg" class="img img-fluid" />

            </div>
            
            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/agenda2.jpg" class="img img-fluid" />

            </div>

            <!--<div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/pluma-2.png" class="img img-fluid" />

            </div>

            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/pluma.png" class="img img-fluid" />

            </div>

            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/taza-1.png" class="img img-fluid" />

            </div>

            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/taza-2.png" class="img img-fluid" />

            </div>

            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/libreta-2.png" class="img img-fluid" /></div>

            <div class="col-6 col-md-3 col-lg-3 p-0 text-center"><img src="./assets/img/productos/libreta-3.png" class="img img-fluid" /></div>

            <div class="col-6 col-md-3 col-lg-12 p-0 text-center"><img src="./assets/img/productos/libreta.png" class="img img-fluid" /></div>-->
